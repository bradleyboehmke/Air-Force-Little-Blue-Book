# This script imports the 2012 Air Force Little Blue Book text document and 
...
bigram_df %>%
        ...
        ylab("") +
        theme(axis.text.y = element_text(size = 12)) +
        ggtitle("Top 10 Bi-grams in 2012")
...
trigram_df %>%
        ...
        theme(axis.text.y = element_text(size = 12)) +
        ggtitle("Top 5 Most Frequent Tri-grams in 2012")
...
quadgram_df %>%
        ...
        ylab("Term") +
        theme(axis.text.y = element_text(size = 12)) +
        ggtitle("Top 5 Most Frequent 4-grams in 2012")  
